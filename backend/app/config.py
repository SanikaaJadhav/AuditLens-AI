...
BILL_OCR_TIMEOUT_SECONDS = int(_env_first("BILL_OCR_TIMEOUT_SECONDS", default="18"))
BILL_IMAGE_OCR_MAX_DIMENSION = int(_env_first("BILL_IMAGE_OCR_MAX_DIMENSION", default="1800"))
